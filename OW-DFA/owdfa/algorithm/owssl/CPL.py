...
class CPL(SSLModel):
    def __init__(self, args):
        ...
        self.eta4 = args.method.CPL.eta4
        self.eta5 = args.method.CPL.eta5
        self.batch_size = args.train.batch_size
        
    def get_loss_names(self):
        loss_name = ['total_loss', 'ce_loss',
                     'glv_loss', 'csp_loss', 'en_loss', 'aux_loss', 'match_loss']
        return loss_name
    ...
    def loss(self, **kwargs):
        ...
        total_loss = ce_loss + self.eta1 * glv_loss + \
            self.eta2 * csp_loss - self.eta3 * en_loss + aux_loss * self.eta4 + match_loss * self.eta5
